...
4. Run `consulting-research-miner` if the research wiki advanced since `integrations/research/_work/LAST_MINED` — harvest fresh agent/skill/compound-engineering ideas into `content/ideas/` (delta-guarded; no-ops if nothing's new).
